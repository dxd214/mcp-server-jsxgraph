...
const PointSchema = z.object({
  ...
  color: z.string().optional().default("#0066cc").describe("Color of the point"),
...
const LineSchema = z.object({
  ...
  type: z.enum(["line", "segment", "ray"]).optional().default("segment").describe("Type of line: line (infinite), segment (between points), or ray (from point1 through point2)"),
...
const CircleSchema = z.object({
  ...
  color: z.string().optional().default("#0066cc").describe("Color of the circle"),
...
const PolygonSchema = z.object({
  vertices: z.array(z.string()).min(3).describe("Array of point names forming the polygon vertices"),
  color: z.string().optional().default("#0066cc").describe("Border color of the polygon"),
  fillColor: z.string().optional().default("#0066cc").describe("Fill color of the polygon"),
...
const AngleSchema = z.object({
  ...
  type: z.enum(["arc", "sector"]).optional().default("arc").describe("Display as arc or filled sector"),
  color: z.string().optional().default("#ff9900").describe("Color of the angle"),
...
const schema = {
  ...
  construction: z
    .object({
      perpendicular: z.array(z.object({
    ...
    .optional()
    .describe("Geometric constructions like perpendiculars, parallels, midpoints, and angle bisectors"),
  style: z
    .object({
