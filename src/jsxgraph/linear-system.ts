...
const LinearInequalitySchema = z.object({
  ...
  fillColor: z
    ...
    .optional()
    .default("#0066cc")
    .describe("Fill color for the feasible region"),
  fillOpacity: z
    .number()
    .optional()
    .default(0.2)
  ...
  borderColor: z
    ...
    .optional()
    .default("#0066cc")
    .describe("Color of the boundary line"),
  borderDash: z
    .number()
    .optional()
    .describe("Dash style for strict inequalities (< or >)"),
  ...
  objectives: z
    .array(
      z.object({
        a: z
          .number()
          .describe("Coefficient of x in objective function (z = ax + by)"),
        b: z
          .number()
          .describe("Coefficient of y in objective function (z = ax + by)"),
        name: z
          .string()
          .optional()
          .default("z")
          .describe("Name of the objective function"),
        showOptimal: z
          .boolean()
          .optional()
          .default(true)
          .describe("Whether to find and show optimal points"),
        type: z
          .enum(["max", "min"])
          .optional()
          .default("max")
          .describe("Optimization type"),
      }),
    )
    .optional()
